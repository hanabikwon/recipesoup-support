  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) {
          final coordinator = BurrowUnlockCoordinator(hiveService: hiveServiceSingleton);
          final provider = BurrowProvider(unlockCoordinator: coordinator);
          debugPrint('🔥 MAIN DEBUG: BurrowProvider using BurrowUnlockCoordinator');
          return provider;
        }),
        ChangeNotifierProvider(create: (_) {
